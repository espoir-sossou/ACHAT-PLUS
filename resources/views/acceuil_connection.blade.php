            ...
            <div class="col-lg-6 ">
                ...
                <div class=" connection_card p-5 mb-5">
                  ...
                  @endif
                    ...
                    <h2 class="text-center pt-4" style="font-family: 'Merienda', cursive;font-family: 'Yatra One', cursive;">Connection</h2>
                   <div class="text-center "><a class="" href="/index/conn/signUp"  style="font-size: 14px; text-decoration:none;color:rgb(83, 81, 81); text-decoration:underline">JE CREE MON COMPTE</a></div>
                    <form class="pt-3 " action="/index/conn" method="POST">
                      @method('POST')
                      @csrf
                        <div class="mb-3">
                          <label for="exampleInputEmail1" class="form-label" style="font-size: 15px">ADDRESSE MAIL</label>
                          <input type="email"  class="form-control" id="exampleInputEmail1" placeholder="exemple@gmail.com" aria-describedby="emailHelp" name="email" value={{old('email')}}>
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label" style="font-size: 15px">MOT DE PASSE</label>
                          <input type="password"  class="form-control" id="exampleInputPassword1" placeholder="........" name="passwd"  value={{old('passwd')}}>
                          <div class="mt-2" ><a href="/index/conn/resetPaswd" style=" text-decoration:none;color:rgb(21, 20, 20)"><p class="mots_pass_oublier" style="font-size: 15px;">MOT DE PASSE OUBLIER ?</p></a></div>
                        </div>
                       <div class="pb-3 mt-5" style="text-align: center"><button type="submit" class="btn  w-100 " style=" background-color:#007266;color:white" >CONNECTION</button></div>
                    </form>
